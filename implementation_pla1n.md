...
### ~~CRIT-1: `ZETAS` Table Values Do Not Match Reference Implementation~~ (✅ FIXED BY USER)
...
### ~~CRIT-2: `inv_ntt` Butterfly Subtraction Has Inverted Sign~~ (✅ FIXED BY USER)
...
### ~~SEC-1: **~20 Debug `println!()` Statements Leak Secret Material** 🔥~~ (✅ FIXED BY USER)
...
|----------|--------|--------|--------|
| **P0** | ~~SEC-1: Remove println leaks~~ | 15 min | ✅ Fixed by user |
| **P0** | ~~CRIT-1: Fix ZETAS table~~ | 2-3 hr | ✅ Fixed by user |
| **P0** | ~~CRIT-2: Fix inv_ntt sign~~ | 5 min | ✅ Fixed by user |
